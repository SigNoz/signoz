...
test.describe('Home Page - Page Load', () => {
  ...
  test('TC-01: home page loads after login', async ({ page }) => {
  ...
  test('TC-02: ingestion status banners are visible', async ({ page }) => {
...
test.describe('Home Page - Services Widget', () => {
  ...
  test('TC-11: services table is visible with correct columns', async ({ page }) => {
  ...
  test('TC-12: All Services link navigates', async ({ page }) => {
...
test.describe('Home Page - Alerts Widget', () => {
  ...
  test('TC-13: alerts section shows firing alerts', async ({ page }) => {
  ...
  test('TC-14: All Alert Rules link navigates', async ({ page }) => {
...
test.describe('Home Page - Dashboards Widget', () => {
  ...
  test('TC-15: dashboards section shows recent dashboards', async ({ page }) => {
    await expect(page.getByRole('link', { name: 'All Dashboards' })).toBeVisible();
    await expect(page.getByRole('button', { name: /alert-rules/ }).first()).toBeVisible();
  });

  test('TC-16: All Dashboards link navigates', async ({ page }) => {
...
test.describe('Home Page - Saved Views Widget', () => {
  ...
  test('TC-17: saved views tabs switch between signal types', async ({ page }) => {
  ...
  test('TC-18: All Views link navigates to saved views', async ({ page }) => {

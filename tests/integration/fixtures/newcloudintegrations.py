...
from fixtures.newcloudintegrationutils import new_setup_create_account_mocks
...
def new_create_cloud_integration_account(
    ...
    def _create(
        ...
        new_setup_create_account_mocks(signoz, make_http_mocks)

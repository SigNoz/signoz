...
def test_health(
    ...
    # 'signoz' is an object that knows where the service is running
    url = signoz.self.host_configs["8080"].get("/api/v1/health")
    assert requests.get(url).status_code == HTTPStatus.OK

...
CONTENT_TEMPLATING_TEST = [
    ...
    types.AlertManagerNotificationTestCase(
        name="email_logs_custom_templating",
        rule_path="alertmanager/content_templating/logs_rule.json",
        alert_data=[
            types.AlertData(
                type="logs",
        ...
        notification_expectation=types.AMNotificationExpectation(
            ...
            notification_validations=[
                types.NotificationValidation(
                    destination_type="email",
                    validation_data={
                        "subject": "[firing] Payment failure spike in payment-service",
                        "html": '<!DOCTYPE html>\n<html lang="en">\n\n<head>\n  <meta charset="utf-8"/>\n  <meta name="viewport" content="width=device-width, initial-scale=1.0">\n  <meta http-equiv="X-UA-Compatible" content="IE=edge">\n  <title>[firing] Payment failure spike in payment-service</title>\n  <style>\n    code {\n      background: #f0f0f0;\n      padding: 2px 6px;\n      border-radius: 3px;\n      font-family: \'SFMono-Regular\', Consolas, \'Liberation Mono\', Menlo, monospace;\n      font-size: 13px;\n    }\n    pre {\n      background: #f0f0f0;\n      padding: 12px 16px;\n      border-radius: 6px;\n      font-size: 13px;\n      overflow-x: auto;\n      white-space: pre;\n    }\n    pre code {\n      background: none;\n      padding: 0;\n      border-radius: 0;\n      font-size: inherit;\n    }\n    table:not([role="presentation"]) {\n      width: 100%;\n      border-collapse: collapse;\n      font-size: 14px;\n    }\n    table:not([role="presentation"]) th {\n      font-weight: 600;\n      text-align: left;\n      padding: 8px 12px;\n      border-bottom: 2px solid #d0d0d0;\n    }\n    table:not([role="presentation"]) td {\n      padding: 8px 12px;\n      border-bottom: 1px solid #e8e8e8;\n    }\n    table:not([role="presentation"]) tr:last-child td {\n      border-bottom: none;\n    }\n  </style>\n</head>\n\n<body style="margin:0;padding:0;font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Roboto,\'Helvetica Neue\',Arial,sans-serif;line-height:1.6;color:#333;background:#fff">\n  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#fff">\n    <tr>\n      <td align="center" style="padding:0">\n        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;border:1px solid #e2e2e2;border-radius:12px;overflow:hidden">\n\n          <tr>\n            <td align="center" style="padding:20px 20px 12px">\n              <h2 style="margin:0 0 8px;font-size:20px;color:#333">[firing] Payment failure spike in payment-service</h2>\n              <p style="margin:0;font-size:14px;color:#666">\n                Status: <strong>firing</strong>\n                 | Firing: <strong style="color:#e53e3e">1</strong>\n                \n              </p>\n            </td>\n          </tr>\n\n          <tr>\n            <td style="padding:0 20px">\n              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">\n                <tr><td style="border-top:1px solid #e2e2e2;font-size:0;line-height:0" height="1">&nbsp;</td></tr>\n              </table>\n            </td>\n          </tr>\n\n          \n          <tr>\n            <td style="padding:8px 20px">\n              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">\n                <tr>\n                  <td style="padding:16px;background:#fafafa;border:1px solid #e8e8e8;border-radius:6px">\n                    <p><strong>Severity:</strong> critical\n<strong>Status:</strong> firing</p>\n<p><strong>Service:</strong> payment-service</p>\n<p><strong>Condition (critical):</strong></p>\n<ul>\n<li><strong>Current:</strong> 1</li>\n<li><strong>Threshold:</strong> above 0</li>\n</ul>\n<p><strong>Description:</strong> Payment failures observed at 1 over the evaluation window, crossing the critical threshold of above 0 on payment-service. Investigate downstream payment processor health.</p>\n<p><strong>Runbook:</strong> <a href="https://signoz.io/docs/runbooks/payment-failure-spike">https://signoz.io/docs/runbooks/payment-failure-spike</a></p>\n\n                  </td>\n                </tr>\n              </table>\n            </td>\n          </tr>\n          \n\n          \n          <tr>\n            <td style="padding:16px 20px">\n              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">\n                <tr>\n                  <td align="center">\n                    <a href="http://localhost:8080" target="_blank" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#fff;background:#4E74F8;text-decoration:none;border-radius:4px">\n                      View in SigNoz\n                    </a>\n                  </td>\n                </tr>\n              </table>\n            </td>\n          </tr>\n          \n\n          <tr>\n            <td align="center" style="padding:8px 16px 16px">\n              <p style="margin:0;font-size:12px;color:#999;line-height:1.5">\n                Sent by SigNoz AlertManager\n              </p>\n            </td>\n          </tr>\n        </table>\n      </td>\n    </tr>\n  </table>\n</body>\n\n</html>',
                    },
                ),
            ],
        ),
    ...
    types.AlertManagerNotificationTestCase(
        name="email_traces_custom_templating",
        rule_path="alertmanager/content_templating/traces_rule.json",
        alert_data=[
            types.AlertData(
                type="traces",
                data_path="alertmanager/content_templating/traces_data.jsonl",
            ),
        ],
        channel_config=email_default_config,
        notification_expectation=types.AMNotificationExpectation(
            ...
            notification_validations=[
                types.NotificationValidation(
                    destination_type="email",
                    validation_data={
                        "subject": "[firing] p90 latency high on checkout-service",
                        "html": '<!DOCTYPE html>\n<html lang="en">\n\n<head>\n  <meta charset="utf-8"/>\n  <meta name="viewport" content="width=device-width, initial-scale=1.0">\n  <meta http-equiv="X-UA-Compatible" content="IE=edge">\n  <title>[firing] p90 latency high on checkout-service</title>\n  <style>\n    code {\n      background: #f0f0f0;\n      padding: 2px 6px;\n      border-radius: 3px;\n      font-family: \'SFMono-Regular\', Consolas, \'Liberation Mono\', Menlo, monospace;\n      font-size: 13px;\n    }\n    pre {\n      background: #f0f0f0;\n      padding: 12px 16px;\n      border-radius: 6px;\n      font-size: 13px;\n      overflow-x: auto;\n      white-space: pre;\n    }\n    pre code {\n      background: none;\n      padding: 0;\n      border-radius: 0;\n      font-size: inherit;\n    }\n    table:not([role="presentation"]) {\n      width: 100%;\n      border-collapse: collapse;\n      font-size: 14px;\n    }\n    table:not([role="presentation"]) th {\n      font-weight: 600;\n      text-align: left;\n      padding: 8px 12px;\n      border-bottom: 2px solid #d0d0d0;\n    }\n    table:not([role="presentation"]) td {\n      padding: 8px 12px;\n      border-bottom: 1px solid #e8e8e8;\n    }\n    table:not([role="presentation"]) tr:last-child td {\n      border-bottom: none;\n    }\n  </style>\n</head>\n\n<body style="margin:0;padding:0;font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Roboto,\'Helvetica Neue\',Arial,sans-serif;line-height:1.6;color:#333;background:#fff">\n  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#fff">\n    <tr>\n      <td align="center" style="padding:0">\n        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;border:1px solid #e2e2e2;border-radius:12px;overflow:hidden">\n\n          <tr>\n            <td align="center" style="padding:20px 20px 12px">\n              <h2 style="margin:0 0 8px;font-size:20px;color:#333">[firing] p90 latency high on checkout-service</h2>\n              <p style="margin:0;font-size:14px;color:#666">\n                Status: <strong>firing</strong>\n                 | Firing: <strong style="color:#e53e3e">1</strong>\n                \n              </p>\n            </td>\n          </tr>\n\n          <tr>\n            <td style="padding:0 20px">\n              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">\n                <tr><td style="border-top:1px solid #e2e2e2;font-size:0;line-height:0" height="1">&nbsp;</td></tr>\n              </table>\n            </td>\n          </tr>\n\n          \n          <tr>\n            <td style="padding:8px 20px">\n              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">\n                <tr>\n                  <td style="padding:16px;background:#fafafa;border:1px solid #e8e8e8;border-radius:6px">\n                    <p><strong>Severity:</strong> critical\n<strong>Status:</strong> firing</p>\n<p><strong>Service:</strong> checkout-service</p>\n<p><strong>Condition (critical):</strong></p>\n<ul>\n<li><strong>Current:</strong> 3.3 s</li>\n<li><strong>Threshold:</strong> above 1 s</li>\n</ul>\n<p><strong>Description:</strong> p90 request latency on checkout-service reached 3.3 s, crossing the critical threshold of above 1 s. Investigate downstream dependencies and recent deploys.</p>\n<p><strong>Runbook:</strong> <a href="https://signoz.io/docs/runbooks/high-latency">https://signoz.io/docs/runbooks/high-latency</a></p>\n\n                  </td>\n                </tr>\n              </table>\n            </td>\n          </tr>\n          \n\n          \n          <tr>\n            <td style="padding:16px 20px">\n              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">\n                <tr>\n                  <td align="center">\n                    <a href="http://localhost:8080" target="_blank" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#fff;background:#4E74F8;text-decoration:none;border-radius:4px">\n                      View in SigNoz\n                    </a>\n                  </td>\n                </tr>\n              </table>\n            </td>\n          </tr>\n          \n\n          <tr>\n            <td align="center" style="padding:8px 16px 16px">\n              <p style="margin:0;font-size:12px;color:#999;line-height:1.5">\n                Sent by SigNoz AlertManager\n              </p>\n            </td>\n          </tr>\n        </table>\n      </td>\n    </tr>\n  </table>\n</body>\n\n</html>',
                    },
                ),
            ],
        ),

...
<p align="center">
  ...
  <a href="https://github.com/SigNoz/signoz/releases"><b>版本发布</b></a> ·
...
#### [APM 概览](https://signoz.io/docs/apm-and-distributed-tracing/application-details/)
...
#### [日志管理](https://signoz.io/docs/logs-management/overview/)
...
#### [指标和仪表盘](https://signoz.io/docs/metrics-management/overview/)
...
#### [基础设施监控](https://signoz.io/docs/infrastructure-monitoring/overview/)
...
#### [LLM 和 AI 可观测性](https://signoz.io/docs/llm-observability/)
...
[**SigNoz MCP server 文档**](https://signoz.io/docs/ai/signoz-mcp-server/) · [**Agent skills 文档**](https://signoz.io/docs/ai/agent-skills/#install-the-plugin)

<p align="center">
  <img alt="SigNoz Noz 界面与基于 MCP 的 Agent 工作流" src="docs/readme-assets/monitor/agent-native.png" width="900">
</p>

#### [分布式链路追踪](https://signoz.io/docs/apm-and-distributed-tracing/traces-user-guides/)
...
加入 <a href="https://signoz.io/slack">SigNoz Slack 社区</a>，阅读 <a href="https://signoz.io/docs/">文档</a>，在 <a href="https://github.com/SigNoz/signoz/discussions">GitHub Discussions</a> 中发起讨论，或阅读 <a href="CONTRIBUTING.md">CONTRIBUTING.md</a> 参与贡献。

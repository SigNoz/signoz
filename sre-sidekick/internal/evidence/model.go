...
type Snapshot struct {
	...
	AvailableSignals map[string]bool      `json:"available_signals,omitempty"`
...
func (s Snapshot) SignalAvailable(signal string) bool {
	if s.AvailableSignals != nil {
		return s.AvailableSignals[signal]
	}
	return s.Records(signal) != nil
}

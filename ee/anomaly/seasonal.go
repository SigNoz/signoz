...
// getMatchingSeries gets the matching series from the query result for the given series.
...
// getMovingAvg gets the moving average for the given series for the given window size and start index.

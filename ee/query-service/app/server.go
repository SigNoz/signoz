...
func NewServer(serverOptions *ServerOptions) (*Server, error) {
	...
	usageManager, err := usage.New(modelDao, serverOptions.SigNoz.License, serverOptions.SigNoz.TelemetryStore.ClickhouseDB(), serverOptions.SigNoz.Zeus,serverOptions.SigNoz.Modules.Organization)
	if err != nil {
		return nil, err
	}

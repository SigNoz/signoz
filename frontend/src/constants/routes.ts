const ROUTES = {
	...
	LLM_OBSERVABILITY_ATTRIBUTE_MAPPING: '/ai-observability/attribute-mapping',
	LLM_OBSERVABILITY_BASE: '/ai-observability',
	LLM_OBSERVABILITY_OVERVIEW: '/ai-observability/overview',
	LLM_OBSERVABILITY_CONFIGURATION: '/ai-observability/configuration',
} as const;

export enum LOCALSTORAGE {
	...
	// Persisted state beats defaultVisibility, so a changed column set needs a new suffix.
	AI_OBSERVABILITY_TRACE_VIEW_COLUMNS = 'AI_OBSERVABILITY_TRACE_VIEW_COLUMNS_V2',

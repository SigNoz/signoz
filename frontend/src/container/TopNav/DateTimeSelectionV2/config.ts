...
// Allowlist: only show TopNav global time picker on these routes.
// This is safer than a denylist because new routes default to hidden.
export const routesToShowTopNav = [
        ROUTES.SERVICE_MAP,
        ROUTES.TRACE,
        ROUTES.APPLICATION,
...
// Subset of allowed routes where the DateTimePicker is shown but disabled
export const routesToDisableDateTimePicker = [
        ROUTES.LOGS_EXPLORER,
        ROUTES.LIVE_LOGS,
];

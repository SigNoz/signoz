...
async function expandAllCards(): Promise<void> {
	...
	const toggleButton = screen.getByTestId('toggle-all-button');
...
describe('PermissionEditor', () => {
	...
	describe('collapse/expand all resources', () => {
		it('shows expand all button by default when cards are collapsed', () => {
			renderPage();
		...
		it('shows collapse all button when all cards are expanded', async () => {
			renderPage();
			await expandAllCards();

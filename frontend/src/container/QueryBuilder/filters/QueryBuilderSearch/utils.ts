...
export const tagRegexp = /^\s*(.*?)\s*(\bIN\b|\bNOT_IN\b|\bLIKE\b|\bNOT_LIKE\b|\bREGEX\b|\bNOT_REGEX\b|\b=\b|\b!=\b|\bEXISTS\b|\bNOT_EXISTS\b|\bCONTAINS\b|\bNOT_CONTAINS\b|\b>=\b|\b>\b|\b<=\b|\b<\b|\bHAS\b|\bNHAS\b)\s*(.*)$/gi;

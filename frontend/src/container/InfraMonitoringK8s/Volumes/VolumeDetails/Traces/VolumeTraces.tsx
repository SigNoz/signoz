import './VolumeTraces.styles.scss';
...
import { getVolumeTracesQueryPayload, selectedColumns } from './constants';
...
function VolumeTraces({
	...
	return (
		<div className="volume-metric-traces">
			<div className="volume-metric-traces-header">
			...
			{!isError && traces.length > 0 && (
				<div className="volume-traces-table">

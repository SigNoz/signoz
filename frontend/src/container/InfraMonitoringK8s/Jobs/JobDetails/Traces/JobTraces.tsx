...
import { getJobTracesQueryPayload, selectedColumns } from './constants';
...
function JobTraces({
	...
	return (
		<div className="job-metric-traces">
			<div className="job-metric-traces-header">
			...
			{!isError && traces.length > 0 && (
				<div className="job-traces-table">

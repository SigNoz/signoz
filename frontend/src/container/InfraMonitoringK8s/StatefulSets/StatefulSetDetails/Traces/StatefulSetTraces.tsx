import './StatefulSetTraces.styles.scss';
...
import { getStatefulSetTracesQueryPayload, selectedColumns } from './constants';
...
function StatefulSetTraces({
	...
	const queryPayload = useMemo(
		() =>
			getStatefulSetTracesQueryPayload(
				timeRange.startTime,
				timeRange.endTime,
	...
	return (
		<div className="statefulSet-metric-traces">
			<div className="statefulSet-metric-traces-header">
			...
			{!isError && traces.length > 0 && (
				<div className="statefulSet-traces-table">

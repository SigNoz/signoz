import './DaemonSetTraces.styles.scss';
...
import { getDaemonSetTracesQueryPayload, selectedColumns } from './constants';
...
function DaemonSetTraces({
	...
	const queryPayload = useMemo(
		() =>
			getDaemonSetTracesQueryPayload(
				timeRange.startTime,
				timeRange.endTime,
	...
	return (
		<div className="daemonSet-metric-traces">
			<div className="daemonSet-metric-traces-header">
			...
			{!isError && traces.length > 0 && (
				<div className="daemonSet-traces-table">

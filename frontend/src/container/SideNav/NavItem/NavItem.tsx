...
export default function NavItem({
    ...
    const sharedClassName = cx('nav-item', isActive ? 'active' : '', isDisabled ? 'disabled' : '');
    ...
    const navItemAsLink = (
        <a href={href} className={sharedClassName} onClick={handleClick} data-testid={dataTestId}>
            {navItemContent}
        </a>
    );

    const navItemAsDiv = (
        <div className={sharedClassName} onClick={handleClick} data-testid={dataTestId}>
            {navItemContent}
        </div>
    );

    const navItem = href ? navItemAsLink : navItemAsDiv;

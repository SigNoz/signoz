...
import { HistogramChartProps } from 'container/Visualization/charts/types';
...
jest.mock('container/Visualization/hooks/useScrollWidgetIntoView', () => ({
	useScrollWidgetIntoView: jest.fn(),
}));

jest.mock('container/Visualization/charts/Histogram/Histogram', () => ({
	__esModule: true,
...
jest.mock(
	'container/Visualization/components/ChartManager/ChartManager',
	() => ({
		__esModule: true,
		default: (): JSX.Element => (

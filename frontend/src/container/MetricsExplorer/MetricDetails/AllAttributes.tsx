...
function AllAttributes({
	...
	const goToMetricsExplorerwithAppliedSpaceAggregation = (
		groupBy: string,
		valueCount?: number,
	): void => {
	...
	const goToMetricsExploreWithAppliedAttribute = (
		key: string,
		value: string,
	): void => {
		const compositeQuery = getMetricDetailsQuery(
	...
	const tableData = filteredAttributes

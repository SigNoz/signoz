...
interface UseAIObservabilityTabsResult {
	items: TabItemProps[];
	activeTab: string;
	onTabChange: (key: string) => void;
}

// Drives the top-level AI Observability tabs. Route-driven: the active tab is
...
// design-system Tabs.
export function useAIObservabilityTabs(): UseAIObservabilityTabsResult {
	...
	const items: TabItemProps[] = [
		...
		},
		{
			...
			label: 'Model pricing',
			children: <AIObservabilityModelPricing />,
		},
		{
			key: ATTRIBUTE_MAPPING_KEY,
			label: 'Attribute Mapping',
			children: <AIObservabilityAttributeMapping />,
		},
	];

...
const MetricsAggregateSection = memo(function MetricsAggregateSection({
	...
	const isDistributionPanel = panelType === PANEL_TYPES.DISTRIBUTION;
	...
	const useHistogramLayout = isHistogramMetric && !isDistributionPanel;
	...
	const disableAggregate = isDistributionPanel && isHistogramMetric;
							...
							<div className="metrics-aggregation-section-content-item">
								...
								<div className="metrics-aggregation-section-content-item-value">
									<OperatorsSelect
										...
										operators={operators}
										disabled={disableOperatorSelector || disableAggregate}

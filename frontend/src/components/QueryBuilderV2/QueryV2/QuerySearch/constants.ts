...
// Max number of recents rendered in the autocomplete dropdown. Keep in sync with
// the SCSS `$max-recents-shown` in QuerySearch.styles.scss — the stylesheet sizes
// the dropdown based on this count.

...
import { fetchFieldKeysForQuery } from 'components/QueryBuilderV2/QueryV2/QuerySearch/keySuggestions';
import { DataSource } from 'types/common/queryBuilder';

import ListViewOrderBy from '../ListViewOrderBy';

jest.mock(
	'components/QueryBuilderV2/QueryV2/QuerySearch/keySuggestions',
	() => ({

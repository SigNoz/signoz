		...
		try {
			...
			if (
				...
				dispatch({
					...
					payload: {
						externalCallEndpoint: GetPayloadData(
							getCallDurationResponse.payload,
							startEndTime,
						),
						externalErrorEndpoints: GetPayloadData(
							getErrorPercentageResponse.payload,
							startEndTime,
						),
						addressedExternalCallRPSResponse: GetPayloadData(
							getAddressedCallRPSResponse.payload,
							startEndTime,
						),
						addressedExternalCallDurationResponse: GetPayloadData(

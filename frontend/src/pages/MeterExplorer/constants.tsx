...
import CostPage from 'container/MeterExplorer/Cost/Cost';
...
export const Cost: TabRoutes = {
	Component: CostPage,
	name: (
		<div className="tab-item">
			<TowerControl size={16} /> Breakdown
		</div>
	),
	route: ROUTES.METER_EXPLORER_COST,
	key: ROUTES.METER_EXPLORER_COST,
};

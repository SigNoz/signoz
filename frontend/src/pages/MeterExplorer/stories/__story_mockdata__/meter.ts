...
import type { Widgets } from 'types/api/widgets/widget';
...
const QUICK_FILTERS: TelemetrytypesTelemetryFieldKeyDTO[] =
	QUICK_FILTER_NAMES.map((name) => ({
		name,
		fieldDataType: TelemetrytypesFieldDataTypeDTO.string,
		fieldContext: TelemetrytypesFieldContextDTO.resource,
	}));

export const meterQuickFiltersResponse = (count: number): GetQuickFilters200 =>
	quickFiltersResponse(
		QuickfiltertypesSourceDTO.meter,

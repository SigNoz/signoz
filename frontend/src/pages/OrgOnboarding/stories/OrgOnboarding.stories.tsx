...
const answerYourScale = async (canvas: Canvas): Promise<void> => {
	...
	// The next page is set from the profile mutation's result, not from the click.
	await canvas.findByText('Invite your team', undefined, untilRendered);
};
...
const pageStory = storyMocks(orgOnboardingMocks, { layout: 'app' });

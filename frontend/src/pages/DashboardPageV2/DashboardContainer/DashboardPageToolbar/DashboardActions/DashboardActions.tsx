...
function DashboardActions({
	...
	const deleteDisabledReason = useDashboardStore((s) => s.deleteDisabledReason);
	const canDeleteDashboard = useDashboardStore((s) => s.canDeleteDashboard);
	const canReadDashboard = useDashboardStore((s) => s.canEditDashboard);
	...
	return (
		<div className={styles.dashboardActionsContainer}>
			...
			<DisabledControlTooltip reason={editDisabledReason} disabled={!isEditable}>
				<Button
					variant="solid"
					color="secondary"
					className={styles.toolbarButton}

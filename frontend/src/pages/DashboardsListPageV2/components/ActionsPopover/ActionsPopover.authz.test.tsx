...
// Items are disabled both while the check is in flight and when it is denied, so
// assertions have to wait for a signal that only holds once it has resolved.

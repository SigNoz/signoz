...
export const logsQuickFiltersResponse = (count: number): GetQuickFilters200 =>
	quickFiltersResponse(
		QuickfiltertypesSourceDTO.logs,
		quickFiltersListResponse.data.filters.slice(
			0,
			count,

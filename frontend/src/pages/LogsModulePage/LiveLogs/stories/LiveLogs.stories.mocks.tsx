...
import { logsSavedViewsResponse } from '../../SavedViews/stories/__story_mockdata__/savedViews';
import {
	...
	RELATIVE_TIME,
	timeRangeState,
} from '../../stories/__story_mockdata__/logs';
import {
	LIVE_TAIL_LIMIT,
	liveLogsQuery,
	liveLogsStream,
...
export const liveLogsMocks = defineStoryMocks({
	...
	handlers: (values, response) => [
		...
		rest.get(
			...
			response.json(() => logsQuickFiltersResponse(QUICK_FILTER_MAX)),
		),

...
```
<!-- @Pandey can u please add how to form collector name for different configs + I couldn't get this working on my local - OTel Collector pod was crash looping, so I'm blindly trusting the docs here, From what I tried -  service.version={{ .Values.appVersion }} was throwing an error-->

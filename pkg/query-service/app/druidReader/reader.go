...
func (druid *DruidReader) SetTTL(ctx context.Context, metricsParam *model.SetTTLParamsMetrics, tracesParams *model.SetTTLParamsTraces) (*model.SetTTLResponseItem, *model.ApiError) {

...
//	CodeInvalidDashboardID = errors.MustNewCode("invalid_dashboard_id")
//
// )
//
...
//		accountsRepo := newCloudProviderAccountsRepository(sqlStore)
//		serviceConfigRepo := newServiceConfigRepository(sqlStore)
//
//		awsServiceDefinitions, err := services.NewAWSCloudProviderServices()
//		if err != nil {
//			return nil, errors.WrapInternalf(err, errors.CodeInternal, "couldn't create aws service definitions")
//		}
//
//		azureServiceDefinitions, err := services.NewAzureCloudProviderServices()
//		if err != nil {
//			return nil, errors.WrapInternalf(err, errors.CodeInternal, "couldn't create azure service definitions")
//		}
//
//		return &Controller{
...
//	assets integrationstypes.Assets) ([]*dashboardtypes.Dashboard, *model.ApiError) {
//	dashboards := make([]*dashboardtypes.Dashboard, 0)
//
//	for _, d := range assets.Dashboards {
//		author := fmt.Sprintf("%s-integration", cloudProvider)
//		dashboards = append(dashboards, &dashboardtypes.Dashboard{
//			ID:     integrationstypes.GetCloudIntegrationDashboardID(cloudProvider, svcId, d.Id),
//			Locked: true,
//			Data:   *d.Definition,

...
type Reader interface {
	...
	GetFlamegraphSpansForTrace(ctx context.Context, traceID string, req *model.GetFlamegraphSpansForTraceParams) (*model.SearchFlamegraphTracesV3Response, *model.ApiError)

...
type Reader interface {
	...
	// Search Interfaces
	SearchTraces(ctx context.Context, params *model.SearchTracesParams, smartTraceAlgorithm func(payload []model.SearchSpanResponseItem, targetSpanId string, levelUp int, levelDown int, spanLimit int) ([]model.SearchSpansResult, error), uncollapsedNodes *model.SearchTraceRequest) (*[]model.SearchSpanResponseItem, error)

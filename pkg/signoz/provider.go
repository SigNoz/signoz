...
func NewNotificationRoutingProviderFactories(routeStore routeTypes.RouteStore) factory.NamedMap[factory.ProviderFactory[nfrouting.NotificationRoutes, nfrouting.Config]] {
	return factory.MustNewNamedMap(

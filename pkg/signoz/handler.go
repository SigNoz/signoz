...
func NewHandlers(modules Modules, providerSettings factory.ProviderSettings, querier querier.Querier, licensing licensing.Licensing, global global.Global, flagger flaggerPkg.Flagger) Handlers {
	return Handlers{

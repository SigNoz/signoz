	...
	cases := []struct {
		...
		},
		{
			...
			expected: qbtypes.Statement{
				...
				Args:  []any{"system.memory.usage", uint64(1747936800000), uint64(1747983420000), "unspecified", false, "big-data-node-1", "system.memory.usage", uint64(1747947360000), uint64(1747983420000), 0},
			},
			expectedErr: nil,
		},
		{

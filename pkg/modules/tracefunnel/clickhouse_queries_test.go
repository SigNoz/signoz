	...
	tests := []struct {
	...
	}{
		{
			...
			wantContains: []string{
				...
				"ifNaN(avgIf((toUnixTimestamp64Nano(t2_time) - toUnixTimestamp64Nano(t1_time))/1e6",
				"ifNaN(quantileIf(0.99)((toUnixTimestamp64Nano(t2_time) - toUnixTimestamp64Nano(t1_time))/1e6",
		...
		},
		{
			...
			wantContains: []string{
				...
				"ifNaN(avgIf((toUnixTimestamp64Nano(t4_time) - toUnixTimestamp64Nano(t1_time))/1e6",
			},
		},
	}

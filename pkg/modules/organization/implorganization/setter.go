...
func (module *setter) Create(ctx context.Context, organization *types.Organization, managedRolesCB func(context.Context) error) error {
	...
	if err := managedRolesCB(ctx); err != nil {
		return err
	}

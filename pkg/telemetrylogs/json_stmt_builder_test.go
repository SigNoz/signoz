...
func TestStmtBuilderTimeSeriesBodyGroupByJSON(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			expectedErrContains: "FieldFor not supported for nested fields",
		},
	}

...
func ErrorFromBody(body []byte) *errors.JSON {
	var res ErrorResponse

	// This should never fail since we only call this function on responses that were generated by us.
	// If it does fail, the codebase has failed to use render package for error responses somewhere, and we should fix that instead of trying to handle it here.

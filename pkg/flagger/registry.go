...
var (
	...
	FeatureEnableParallelQueries  = featuretypes.MustNewName("enable_parallel_queries")
)
...
func MustNewRegistry() featuretypes.Registry {
	registry, err := featuretypes.NewRegistry(
		...
		&featuretypes.Feature{
			Name:           FeatureEnableParallelQueries,
			Kind:           featuretypes.KindBoolean,
			Stage:          featuretypes.StageExperimental,
			Description:    "Controls whether the querier executes the sub-queries of a composite query range request in parallel",
			DefaultVariant: featuretypes.MustNewName("disabled"),
			Variants:       featuretypes.NewBooleanVariants(),
		},
	)

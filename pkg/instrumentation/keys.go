...
const (
	...
	// ModuleName is the logical module or component name (e.g. "builder-query", "clickhouse-reader").
	...
	// PanelType is the panel type: "time-series", "table", "text", "alert".
	PanelType = "panel.type"
	// QueryType is the query type: "promql", "clickhouse", "trace-operator".

...
// QueryParamsSchema documents the /query parameters. The endpoints accept
// them as URL query params or a form-encoded body, on GET and POST alike.
...
// QueryRangeParamsSchema documents the /query_range parameters.
...
// SuccessResponseSchema documents the success envelope.
...
// ErrorResponseSchema documents the error envelope. Status codes follow
// Prometheus: bad_data 400, execution 422, canceled/timeout 503, internal
// 500.

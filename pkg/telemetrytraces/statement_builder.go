...
func (b *traceQueryStatementBuilder) buildHeatmapHistogramCTE(
	ctx context.Context,
...
func (b *traceQueryStatementBuilder) buildHeatmapBucketsCTE(
...
func (b *traceQueryStatementBuilder) buildHeatmapCountsCTE(
	ctx context.Context,
	...
	countsSB.From(fmt.Sprintf("%s.%s", DBName, SpanIndexV3TableName))
...
func (b *traceQueryStatementBuilder) buildHeatmapTimestampsCTE(
	ctx context.Context,
	query qbtypes.QueryBuilderQuery[qbtypes.TraceAggregation],
	start, end uint64,
	keys map[string][]*telemetrytypes.TelemetryFieldKey,
	...
	tsSB.From(fmt.Sprintf("%s.%s", DBName, SpanIndexV3TableName))

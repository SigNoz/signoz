...
func (m *defaultFieldMapper) FieldFor(
	...
	case schema.ColumnTypeEnumLowCardinality:
		...
		case schema.ColumnTypeEnumString:
			return column.Name, nil
		default:
			return "", errors.NewInvalidInputf(errors.CodeInvalidInput, "value type %s is not supported for low cardinality column type %s", elementType, column.Type).WithInvalidReferences(key.String())
		}
	case schema.ColumnTypeEnumMap:
		...
		default:
			return "", errors.NewInvalidInputf(errors.CodeInvalidInput, "value type %s is not supported for map column type %s", valueType, column.Type).WithInvalidReferences(key.String())
		}
	}

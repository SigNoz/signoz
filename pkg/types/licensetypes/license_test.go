...
func TestNewLicenseV3(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			pass:  false,
			error: errors.New("invalid-input(invalid_input): status key is not a valid string"),
		},
		{
			...
			pass:  false,
			error: errors.New("invalid-input(invalid_input): plan key is missing"),
		},
		{
			...
			pass:  false,
			error: errors.New("invalid-input(invalid_input): plan key is not a valid map[string]interface {}"),
		},
		{
			...
			pass:  false,
			error: errors.New("invalid-input(invalid_input): name key is missing"),
		},
		{

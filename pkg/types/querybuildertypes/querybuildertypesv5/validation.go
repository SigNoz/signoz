...
func (r *QueryRangeRequest) Validate() error {
	...
	case RequestTypeRaw, RequestTypeRawStream, RequestTypeTimeSeries, RequestTypeScalar, RequestTypeTrace, RequestTypeDistribution:
		// Valid request types
	default:
		return errors.NewInvalidInputf(
			errors.CodeInvalidInput,
			...
			"Valid request types are: raw, timeseries, scalar, trace, distribution",
		)
	}

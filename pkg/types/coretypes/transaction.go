...
type Transaction struct {
	ID       valuer.UUID `json:"-"`
	Relation Verb        `json:"relation" required:"true"`
...
func NewTransaction(relation Verb, object Object) (*Transaction, error) {
	if err := ErrIfVerbNotValidForType(relation, object.Resource.Type); err != nil {
		return nil, err
	}
